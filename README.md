...
Reference implementation and artifact-evaluation harness for the SuperInfer
paper, built as a fork of [vLLM v0.6.6.post1](https://github.com/vllm-project/vllm/tree/v0.6.6.post1).
